        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Conte-nos sobre seu projeto de importação..."
                />
              </div>

              <button
                type="submit"
                className="w-full bg-secondary hover:bg-secondary/90 text-white font-bold py-4 rounded-lg text-lg shadow-lg transform transition hover:scale-105"
              >
                Enviar Mensagem
              </button>
            </form>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">contato@jlaimportadora.com.br</p>
                    <p className="text-gray-600">comercial@jlaimportadora.com.br</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Av. Paulista, 1000 - Sala 1001</p>
            ...
            <div className="bg-primary rounded-lg shadow-lg p-8 text-white">
              ...
              <p className="mb-6">Siga-nos nas redes sociais para ficar por dentro das novidades</p>
